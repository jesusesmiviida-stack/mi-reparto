            ...
            <div class="cliente-card ${esEntregado ? 'opacity-40 grayscale' : (cerca ? 'llegada-anim' : '')}">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="https://wa.me/${c.tel}" target="_blank" class="btn-action btn-wa">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.55 4.12 1.51 5.861L0 24l6.337-1.631C8.03 23.361 9.94 24 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.896 0-3.662-.513-5.181-1.404l-.372-.218-3.856.993 1.01-3.684-.239-.38C2.464 15.783 2 13.945 2 12c0-5.514 4.486-10 10-10s10 4.486 10 10-4.486 10-10 10z"/></svg>
                    </a>
                </div>
            </div>
        `;
